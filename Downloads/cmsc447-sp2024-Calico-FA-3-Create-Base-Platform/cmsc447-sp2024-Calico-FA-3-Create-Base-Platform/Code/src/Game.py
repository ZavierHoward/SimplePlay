from flask import Flask, render_template, flash, request, url_for, redirect, send_from_directory,  session
import os
import string
import secrets
    ...
    if request.method == "POST":
        ...
        if pw_hash:
            ...
            if bcrypt.checkpw(pw.encode(), pw_hash.encode()):
                ...
                print("This runs")
                #return render_template("game.html", username="Z", map_path="C:/Users/zavie/Downloads/cmsc447-sp2024-Calico-FA-3-Create-Base-Platform/cmsc447-sp2024-Calico-FA-3-Create-Base-Platform/Resources/5c06418c326c40c596f8d738497d5be5.csv")
                #Uncomment the below line at the end
...
def game(username, game_id):
    ...
    print("Game file path: ", game_file_path)
...
#Need this for csv file directory for game.js - Zavier
